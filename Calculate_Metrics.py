...
class Metric_fun(object):
    ...
    def cv_mat_model_evaluate(self, association_mat, predict_mat):
        ...
        metrics= self.get_metrics(real_score, predict_score)
        # metrics, recall_list, precision_list = self.get_metrics(real_score, predict_score)
        # return metrics,recall_list,precision_list
        return metrics
    ...
    def get_metrics(self, real_score, predict_score):
        ...
        # return [auc[0, 0], aupr[0, 0], f1_score, accuracy, recall, specificity, precision],x_PR,y_PR
